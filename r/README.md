...
rtemis.llm provides functionality to interface with Large Language Models, part of the [rtemis](https://www.rtemis.org) ecosystem. It provides an `Agent` class with support for reasoning, structured output, memory 
...
LLM inference. Supports Ollama, OpenAI-compatible, and Anthropic-compatible endpoints.
